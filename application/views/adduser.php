...
<div class="container" style="margin-bottom:1.5rem">
  ...
  <div class="form-group row">
      ...
      <label for="inputJudgeID" class="col-sm-2 control-label text-right">Username</label><?php echo form_error('aname'); ?><br />
<div class="col-sm-5">
<?php echo form_input(array('id' => 'aname', 'class'=>'form-control','name' => 'aname')); ?><br />
</div></div>
<div class="form-group row">
<label for="inputJudgeID" class="col-sm-2 control-label text-right">Password</label><?php echo form_error('apass'); ?><br />
<div class="col-sm-5">
